      ...
      <div className="container mx-auto px-4 py-6 h-full flex flex-col">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            {searchResult ? `${searchResult.total} offre${searchResult.total > 1 ? 's' : ''} disponible${searchResult.total > 1 ? 's' : ''}` : 'Chargement...'}
          </p>
        </div>
              ...
              <div className="pt-4 flex-shrink-0">
                <Pagination>
                  <PaginationContent>
                    ...
                    <PaginationItem>
                      <PaginationNext 
                        onClick={() => currentPage < searchResult.totalPages && handlePageChange(currentPage + 1)}
                        className={currentPage >= searchResult.totalPages ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}
                      />
                    </PaginationItem>
                  </PaginationContent>
                </Pagination>
