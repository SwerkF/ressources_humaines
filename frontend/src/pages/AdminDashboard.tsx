...
export default function AdminDashboard(): JSX.Element {
    ...
    const { stats, userGrowth, applicationStatus, jobsByContract, monthlyActivity, topCompanies } =
        dashboardData;
            ...
            <div className="container mx-auto px-4 py-8">
                            ...
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    ...
                                    <p className="text-xl font-bold">
                                        {formatNumber(stats.totalCandidats)}
                                    </p>
                                </div>
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    ...
                                    <p className="text-xl font-bold">
                                        {formatNumber(stats.totalEntreprises)}
                                    </p>
                                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Candidatures, offres créées et nouveaux utilisateurs
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ResponsiveContainer width="100%" height={300}>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Entreprises les plus actives sur la plateforme
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <div className="text-right">
                                        <p className="font-semibold">
                                            {formatNumber(company.applicationsReceived)}{" "}
                                            candidatures
                                        </p>
                                        <p className="text-sm text-muted-foreground">
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-red-600">
                                        {formatNumber(stats.rejectedApplications)}
                                    </p>
                                    <p className="text-xs text-muted-foreground">
                                        {Math.round(
