                            ...
                            {isAuthenticated ? (
                                <>
                                    <div className="flex items-center space-x-3">
                                        ...
                                        {user?.email && (user.email === 'demo@traverselarue.fr' || user.email === 'admin@traverselarue.fr' || user.email === 'superadmin@traverselarue.fr') && (
                                ...
                                <>
                                    ...
                                    <Button variant="outline" size="sm" onClick={handleDemoCompanyLogin}>
                                        Démo Entreprise
                                    </Button>
                                    <Button variant="outline" size="sm" onClick={handleDemoAdminLogin} className="text-primary border-primary hover:bg-primary hover:text-white">
