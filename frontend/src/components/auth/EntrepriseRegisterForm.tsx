 ...
 * @returns {JSX.Element}
 */
export default function EntrepriseRegisterForm({ onBack }: EntrepriseRegisterFormProps): JSX.Element {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    // Validation basique
    if (!formData.nomEntreprise || !formData.siret || !formData.nomGerant || 
        !formData.email || !formData.password || !formData.localisation) {
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Créez votre compte pour publier vos offres</p>
            </div>
          </div>
        </div>
      </div>
