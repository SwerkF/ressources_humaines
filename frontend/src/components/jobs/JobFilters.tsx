...
export default function JobFilters({ filters, onFiltersChange }: JobFiltersProps): JSX.Element {
   ...
   */
  const updateFilter = (key: keyof JobFiltersType, value: JobFiltersType[keyof JobFiltersType]): void => {
    onFiltersChange({
      ...filters,
      [key]: value
    })
        ...
        <div className="space-y-4 pt-4 border-t">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => updateFilter('contract', value as JobFiltersType['contract'])}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={filters.work}
                onValueChange={(value) => updateFilter('work', value as JobFiltersType['work'])}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => updateFilter('salaryMax', Number(e.target.value) || 100000)}
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => updateFilter('dateRange', value as JobFiltersType['dateRange'])}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
