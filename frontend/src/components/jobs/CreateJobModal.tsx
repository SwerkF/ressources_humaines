...
export default function CreateJobModal({
    ...
    onClose,
    onJobCreated,
}: CreateJobModalProps): JSX.Element {
    ...
    const validateForm = (): boolean => {
        ...
        if (!formData.exigences.trim()) {
            setError("Les exigences du poste sont obligatoires");
            return false;
        }
        ...
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="exigences">Exigences du poste *</Label>
                        <Textarea
                            id="exigences"
                            value={formData.exigences}
                            onChange={(e) => updateFormData("exigences", e.target.value)}
                            placeholder="Ex: Expérience en React, TypeScript, Next.js, Tailwind CSS, Git"
                            className="min-h-[120px]"
                        />
                    </div>
                    <Separator />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value) =>
                                    updateFormData("contract", value as ContractType)
                                }
                            >
                                <SelectTrigger>
                                    <SelectValue />
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Ajoutez les technologies, outils et compétences nécessaires pour ce
                                poste
                            </p>
                        </div>
                    ...
                    <div className="bg-muted/30 rounded-lg p-4">
                        ...
                        <div className="space-y-2 text-sm">
                            <div>
                                <strong>Poste :</strong> {formData.title || "Titre du poste"}
                            </div>
                            <div>
